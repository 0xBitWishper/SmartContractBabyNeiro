...
contract BabyNeiro is ERC20, Ownable {
    ...
    {   
        _mint(msg.sender, 420_000_000_000_000_000 * (10 ** 9));
        ...
        marketingAddress = 0xdCb0d492394a2417CE01539DB7beaC55b4125F31; 
        devAddress = 0xdf7Ac6B7C3374d0a6174A08177C344c19Ba94e2d; 

        buyTax.marketingTax = 400; // 1% = 100
        buyTax.liquidityTax = 100;
        buyTax.totalTax = buyTax.marketingTax + buyTax.liquidityTax;

        sellTax.marketingTax = 400;
    ...
    function convertTaxes() private {
        ...
        if(tokensForTaxMem.tokensForLiquidity > 0){
            ...
            try dexRouter.addLiquidityETH{value: newBalance}(
            address(this),
            secondMath,
            0,
            0,
    ...
    function updateBuyTax(uint64 _marketingTax, uint64 _liquidityTax) external onlyOwner {
        ...
        taxes.totalTax = _marketingTax + _liquidityTax;
        require(taxes.totalTax  <= 500 || taxes.totalTax <= buyTax.totalTax, "Keep tax below 5%");
    ...
    function updateSellTax(uint64 _marketingTax, uint64 _liquidityTax) external onlyOwner {
        ...
        taxes.liquidityTax = _liquidityTax;
        taxes.totalTax = _marketingTax + _liquidityTax;
        require(taxes.totalTax  <= 500 || taxes.totalTax <= sellTax.totalTax, "Keep tax below 5%");
